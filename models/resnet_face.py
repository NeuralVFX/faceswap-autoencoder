...
class Resnet50_ft_dag(nn.Module):
    ...
    def __init__(self):
        ...
        # Replaced stride 2 with stride 1 for more detail in out perceptual loss
        self.conv1_7x7_s2 = nn.Conv2d(3, 64, kernel_size=[7, 7], stride=(1, 1), padding=(3, 3), bias=False)
    ...
    def forward(self, data):
        ...
        # Replacing MaxPool allows more fidelity in out preceptual loss
        pool1_3x3_s2 = conv1_7x7_s2_bnxx
        # self.pool1_3x3_s2(conv1_7x7_s2_bnxx)
        ...
        return conv2_3_1x1_reduce_bnxx
        """ 
