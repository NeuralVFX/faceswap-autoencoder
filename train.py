...
parser.add_argument('--batch_size', nargs='?', default=6, type=int)
...
parser.add_argument('--perceptual_weight', type=float, default=3.)
parser.add_argument('--disc_perceptual_weight', type=float, default=3.)
